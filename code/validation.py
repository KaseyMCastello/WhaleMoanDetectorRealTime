...
def validation(vald1, device, model, epoch_train_loss):
    ...
    for score_threshold in score_thresholds:
        ...
        precision_recall_output += f"Training epoch {epoch_train_loss} validation metrics for score threshold: {score_threshold}\n"  # Add score threshold to output
